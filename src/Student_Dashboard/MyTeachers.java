 ...
 * @author Muneeb Ahmad
 */
public final class MyTeachers extends javax.swing.JPanel {
     ...
     */
    public MyTeachers() throws SQLException {
        initComponents();
    ...
    MyTeachers(String stud_id) throws SQLException {
        initComponents();
        STUDENT_ID = stud_id;
        con = new connectivity();
        jTable1.getTableHeader().setFont(new Font("segoe UI", Font.BOLD, 12));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "dfads", "dsfdsg", "sdfa", "54", null},
                {"2", "asdf", "dfg", "sadf", "54", null},
                {"3", "asdf", "dsfg", null, "5", null},
                {"4", "sa", "dsg", "sadf", "5", null},
                {"5", "df", "dg", "saf", "5", null},
                {"8", "asdf", "dg", "d", null, null}
            },
            new String [] {
                "Faculity ID", "Faculity Name", "Department", "Semester", "Subject", "Position"
            }
        ) {
    ...
    public final void settable() {
        try {
            myres = con.mystmt.executeQuery("SELECT * FROM assignedsubjects join subject on assignedsubjects.SUB_CODE = subject.SUB_CODE join staff on assignedsubjects.STAFF_ID = staff.STAFF_ID where SEMESTER_NO = '"+Sem_No+"'");
            while (myres.next()) {
                String Fac_Id = myres.getString("STAFF_ID");
                String Fac_Name = myres.getString("SUB_NAME");
                String Sub_Sem = myres.getString("SEMESTER_NO");
                String Sub_Name = myres.getString("SUB_NAME");
                String Fac_Pos = myres.getString("POSITION");

                String resultdata[] = {Fac_Id, Fac_Name, Dept_Code, Sub_Sem, Sub_Name, Fac_Pos};
