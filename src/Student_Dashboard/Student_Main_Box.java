 ...
 * @author Muneeb Ahmad
 */
public class Student_Main_Box extends javax.swing.JFrame {
     ...
     */
    public Student_Main_Box() throws SQLException, IOException {
        initComponents();
    ...
    public Student_Main_Box(String did) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_department_24px.png"))); // NOI18N
        jLabel6.setText("My ClassMates");
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, new java.awt.Color(255, 255, 255)));
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_student_registration_24px.png"))); // NOI18N
        ...
        Namee.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        signOut2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_male_user_24px_5.png"))); // NOI18N
    ...
    public final void fetchUserData() {
        ...
        try {
            ResultSet myres = conn.mystmt.executeQuery("select * from student join person on student.USERID=person.USERID");
            ...
            while (myres.next()) {
                ...
                if (myres.getString("USERID").equals(String.valueOf(UserID))) {
                    ...
                    STUDENT_ID = myres.getString("STUDENT_ID");
    ...
    private void jPanel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel8MouseClicked
        MyTeachers my_tec = null;
        try {
            my_tec = new MyTeachers(STUDENT_ID);
        } catch (SQLException ex) {
            Logger.getLogger(Student_Main_Box.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
        mainPanel.add(my_tec);
        mainPanel.repaint();
        mainPanel.revalidate();
    ...
    private void jPanel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel7MouseClicked
        SubAttendance Atted = null;
        try {
            Atted = new SubAttendance(STUDENT_ID);
        } catch (SQLException ex) {
            Logger.getLogger(Student_Main_Box.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        ...
        try {
            subt = new MySubjects(STUDENT_ID);
        } catch (SQLException ex) {
            Logger.getLogger(Student_Main_Box.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        Classmates clsmate = null;
        try {
            clsmate = new Classmates(STUDENT_ID);
        } catch (SQLException ex) {
            Logger.getLogger(Student_Main_Box.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
        mainPanel.add(clsmate);
        mainPanel.repaint();
        mainPanel.revalidate();
        jPanel3.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, new java.awt.Color(255, 255, 255)));
...
//        System.out.println(posX+","+posY);
    ...
    private void jPanel9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel9MouseClicked
        AttendanceReport AttRep = null;
        try {
            AttRep = new AttendanceReport(STUDENT_ID);
        } catch (SQLException ex) {
            Logger.getLogger(Student_Main_Box.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
        mainPanel.add(AttRep);
        mainPanel.repaint();
        mainPanel.revalidate();
        jPanel9.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 5, 0, 0, new java.awt.Color(255, 255, 255)));
        jPanel3.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, new java.awt.Color(255, 255, 255)));
        jPanel4.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, new java.awt.Color(255, 255, 255)));
        jPanel5.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, new java.awt.Color(255, 255, 255)));
        jPanel6.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 0, new java.awt.Color(255, 255, 255)));
    ...
    private void signOut2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signOut2MouseClicked
        try {
            MyProfile mp = new MyProfile(STUDENT_ID);
            mainPanel.removeAll();
            mainPanel.add(mp);
            mainPanel.repaint();
            mainPanel.revalidate();
    ...
    private void signOut2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signOut2MouseEntered
       signOut2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_male_user_24px_6.png")));
    ...
    private void signOut2MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_signOut2MouseExited
       signOut2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_male_user_24px_5.png")));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new Student_Main_Box().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(Student_Main_Box.class.getName()).log(Level.SEVERE, null, ex);
