 ...
 * @author Muneeb Ahmad
 */
public final class MyMarks extends javax.swing.JPanel {
     ...
     */
    public MyMarks() throws SQLException {
        initComponents();
    ...
    MyMarks(String stud_id) throws SQLException {
        initComponents();
...
//settable();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Name", "Subject", "Subject Type", "Total Marks", "Otained Marks"
            }
        ) {
    ...
    public final void settable() {
        try {
            myres = con.mystmt.executeQuery("select * from marks join subject on marks.SUB_CODE= subject.SUB_CODE where STUDENT_ID = '"+STUDENT_ID+"'");
            int sr = 0;
            while (myres.next()) {
                

                String Obtained_Marks = myres.getString("OBTAINED_MARKS");
                String Sub_name = myres.getString("SUB_NAME");
                String Sub_Total = myres.getString("TOTAL_MARKS");
                Sub_Type = myres.getString("SUBJECT_TYPE");
                System.out.println(Sub_name+"marks are: "+Obtained_Marks);
                
                String resultdata[] = {STUDENT_ID, STUDENT_NAME , Sub_name, Sub_Type, Sub_Total,Obtained_Marks};
