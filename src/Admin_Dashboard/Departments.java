...
public class Departments extends javax.swing.JPanel {
    ...
    public Departments() throws SQLException {
        ...
        jTable1.getColumnModel().getColumn(5).setMaxWidth(52);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr #", "Department ID", "Name", "Students", "Subjects", "No. of Semesters"
            }
        ) {
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
        Add_Department addDept = null;
        try {
            addDept = new Add_Department();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            String Dept_ID = model.getValueAt(index, 1).toString();
            Add_Department ad_Dept = new Add_Department(Dept_ID);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        tMOdel.setRowCount(0);
        try {
            myres = con.mystmt.executeQuery("select d.DEPT_CODE,d.DEPARTMENT_NAME,d.SEMESTER,d.TOTAL_SEMESTER,(select count(*) from student where DEPT_CODE=d.DEPT_CODE) as Students , (select count(*) from subject where DEPT_CODE=d.DEPT_CODE) as Subjects from department d where d.DEPARTMENT_NAME LIKE '"+likeing+"'");
            int sr = 0;
            while (myres.next()) {
                sr++;
                ...
                String Student = myres.getString("Students");
                String Subject = myres.getString("Subjects");

                String resultdata[] = {String.valueOf(sr), "  " + Deptcode, "  " + Deptname, Student, Subject, DeptSemm};
    ...
    public final void settable() {
        try {
            myres = con.mystmt.executeQuery("select d.DEPT_CODE,d.DEPARTMENT_NAME,d.SEMESTER,d.TOTAL_SEMESTER,(select count(*) from student where DEPT_CODE=d.DEPT_CODE) as Students , (select count(*) from subject where DEPT_CODE=d.DEPT_CODE) as Subjects from department d");
            int sr = 0;
            while (myres.next()) {
                sr++;
                String Deptcode = myres.getString("DEPT_CODE");
