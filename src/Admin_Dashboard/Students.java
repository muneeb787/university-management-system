...
public class Students extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr #", "Department ID", "Roll No", "Student name", "Department name", "Semester"
            }
        ) {
    ...
    private void kButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton1ActionPerformed
       Add_student addStud = null;
       addStud = new Add_student();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       if (evt.getClickCount() == 2) {
            ...
            String Stud_Id = model.getValueAt(index, 2).toString();
            String DeptName = model.getValueAt(index, 4).toString();
            Add_student ad_Dept = null;
           try {
               ad_Dept = new Add_student(Stud_Id,DeptName);
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            myres = con.mystmt.executeQuery("select * from student join person on student.USERID=person.USERID join department on student.DEPT_CODE=department.DEPT_CODE where NAME LIKE '"+likeing+"'");   
            int sr=0;
             while(myres.next())
            {
                sr++;
                String StudID = myres.getString("STUDENT_ID");
                String Studname = myres.getString("NAME");
                ...
                String resultdata[] = {String.valueOf(sr),deptCode,StudID,Studname,deptName,sem,};
    ...
    {
        try {
            myres = con.mystmt.executeQuery("select * from student join person on student.USERID=person.USERID join department on student.DEPT_CODE=department.DEPT_CODE");   
            int sr=0;
             while(myres.next())
            {
                sr++;
