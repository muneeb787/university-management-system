 ...
 * @author Muneeb Ahmad
 */
public class Main_Box extends javax.swing.JFrame {
     ...
     */
    public Main_Box() throws SQLException, IOException {
        initComponents();
    ...
    public Main_Box(String did) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Assign Subjects");
    ...
    public final void fetchUserData() {
        ...
        try {
            ResultSet myres = conn.mystmt.executeQuery("select * from admin join person on admin.USERID=person.USERID");
            ...
            if (myres.next()) {
                ...
                input = myres.getBinaryStream("LOGO");
    ...
    private void jPanel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel8MouseClicked
        Assign_Subject Ass_sub = null;
        try {
            Ass_sub = new Assign_Subject();
        } catch (SQLException ex) {
            Logger.getLogger(Main_Box.class.getName()).log(Level.SEVERE, null, ex);
        }
        mainPanel.removeAll();
        mainPanel.add(Ass_sub);
        mainPanel.repaint();
        mainPanel.revalidate();
