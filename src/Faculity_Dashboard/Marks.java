 ...
 * @author Muneeb Ahmad
 */
public final class Marks extends javax.swing.JPanel {
    ...
    Marks(String StaffId1) throws SQLException {
        initComponents();
...
//settable();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student ID", "Name", "Subject", "Total Marks", "Otained Marks"
            }
        ) {
        ...
        if (SubName == ("Select")) {
            ...
            try {
                ...
                if (Sub_Type.equals("Optional")) {
                    ...
                    myres = con.mystmt.executeQuery("select * from student s join person p on s.USERID=p.USERID left join marks m on s.STUDENT_ID=m.STUDENT_ID and m.SUB_CODE='"+Sub_Code+"',subject where s.SEMESTER='"+Sem_No+"' and OPTIONAL_SUBJECT = '"+Sub_Type+"' and subject.SUB_CODE='"+Sub_Code+"'");
                    int sr = 0;
                    if(myres.next())
                    {
                        System.out.println("opt true and myres is: "+myres.next());
                    }
                    else
                    {
                        System.out.println("opt else and myres is: "+myres.next());
                    }
                    while (myres.next()) {
                        sr++;
                        ...
                        String resultdata[] = {StudentID, StudentName, SubName, Total_Marks, Obtain_Marks};
                    ...
                    System.out.println("Sub Code is: "+Sub_Code);
                    myres = con.mystmt.executeQuery("select * from student s join person p on s.USERID=p.USERID left join marks m on s.STUDENT_ID=m.STUDENT_ID and m.SUB_CODE='"+Sub_Code+"',subject where s.SEMESTER='"+Sem_No+"'and subject.SUB_CODE='"+Sub_Code+"'");
                    int sr = 0;
                    if(myres.next())
                    {
                        System.out.println("true and myres is: "+myres.next());
                    }
                    else
                    {
                        System.out.println("else and myres is: "+myres.next());
                    }
                    while (myres.next()) {
                        sr++;
                        String StudentID = myres.getString("STUDENT_ID");
    ...
    public void addtheorymarks() {
        ...
        for (i = 0; i < jTable1.getRowCount(); i++) {
            ...
            String Obt_marts1 = (String) jTable1.getValueAt(i, 4);
            Obt_marts = Integer.parseInt(Obt_marts1);
            System.out.println("Stu Id is : " + StuId);
            System.out.println("Stu Name is : " + StuName);
            System.out.println("Stu Sub is : " + Sub_Code);
            System.out.println("Stu Marks is : " + Obt_marts);
    ...
    public int addStudentTheoryMarks()
	{
		...
		try
		{
			String query="update marks set OBTAINED_MARKS="+Obt_marts+" where SUB_CODE='"+Sub_Code+"' and STUDENT_ID='"+StuId+"'";
